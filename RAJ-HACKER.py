...
jalan("\033[1;91m------------------------------------------------")                                     
jalan("\033[1;93m --Tool Update 100%   Welcome to 𝚁𝙰𝙹 𝙷𝙰𝙲𝙺𝙴𝚁 -----")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:RAJ-KHONDOKAR
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih_super():
	...
	print "  \033[1;91m«---•◈•---Developed Raj Hacker--•◈•---»" #Dev:B4BALOCH
